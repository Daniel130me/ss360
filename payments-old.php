...
<body class="hold-transition sidebar-mini">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="py-2 px-15 bg-white" style="border-radius: 10px;">
                                <div class="mb-3">
                                    <h2 class="mx-0 mt-0 mb-sm-1 mb-2" style="font-size: 23px;">Billings</h2>
                                    <ol class="breadcrumb p-0 bg-white mb-0">
                                        ...
                                        <li class="breadcrumb-item active font-14">Billings</li>
                                    </ol>
                                    <!-- add new assessment button -->
                                    <!-- Button to trigger the Create/Assign Bill Modal -->
                                    <button type="button" class="btn btn-primary btn-sm mb-3 mt-4" data-toggle="modal"
                                        data-target="#createAssignBillModal">
                                        Create/Assign Bill
                                    </button>

                                    <div class="py-2">
                                        <a href="#createBillTypeModal" data-toggle="modal" class="accent">Create New
                                            Bill Type</a>
                                    </div>
                                    <div class="row">
                                ...
                                <div id="student_payment_record_container" class="">
                                    <div id="select-class-message" class="alert alert-info text-center">Select class to
                                        see record.</div>
                                    <div id="estimated-income-section" class="mb-3"
                                        style="gap: 24px; flex-wrap: wrap; display: none;">
                                        <div class="row w-100">
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Nav tabs -->
                    <ul class="nav nav-pills mb-3" id="editBillTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="edit-bill-tab-link" data-toggle="pill" href="#edit-bill-tab"
                                role="tab" aria-controls="edit-bill-tab" aria-selected="true">Edit Bill</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="edit-preview-bill-tab-link" data-toggle="pill"
                                href="#edit-preview-bill-tab" role="tab" aria-controls="edit-preview-bill-tab"
                                aria-selected="false">Preview Bill</a>
                        </li>
                    </ul>
                    <div class="tab-content" id="editBillTabsContent">
                        <!-- Edit Bill Tab Content -->
                        <div class="tab-pane fade show active" id="edit-bill-tab" role="tabpanel"
                            aria-labelledby="edit-bill-tab-link">
                            <form id="editBillForm">
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <select class="form-control select2" id="edit_bill_type" name="bill_type"
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button" class="btn btn-primary btn-sm" id="addEditBreakdownRow">Add
                                        Item</button>
                                </div>
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        ...
                                        <input type="number" step="0.01" class="form-control" id="editSubtotal"
                                            name="edit_subtotal" readonly>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        <label for="editDeductionPurpose">Deduction Purpose</label>
                                        <input type="text" class="form-control" id="editDeductionPurpose"
                                            name="edit_deduction_purpose" placeholder="e.g. Scholarship or Discount">
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <label for="editDeductionPercentage">Deduction Percentage (%)</label>
                                        <input type="number" min="0" max="100" step="0.01" class="form-control"
                                            id="editDeductionPercentage" name="edit_deduction_percentage" value="0">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="number" min="0" max="100" step="0.01" class="form-control"
                                            id="editTaxPercentage" name="edit_tax" value="0">
                                    </div>
                                    <div class="col-md-4 form-group">
                                        <label for="editTotalAmount">Total Amount</label>
                                        <input type="number" step="0.01" class="form-control" id="editTotalAmount"
                                            name="edit_total_amount" readonly required>
                                    </div>
                                    <!-- <div class="col-md-4 form-group">
                                            <label for="editAmountPaid">Amount Paid</label>
                                            <input type="number" step="0.01" class="form-control" id="editAmountPaid" name="edit_amount_paid" value="0">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            <label for="editBalance">Balance</label>
                                            <input type="number" step="0.01" class="form-control" id="editBalance" name="edit_balance" readonly>
                                        </div>
                                        <div class="col-md-6 form-group">
                                            <label for="editStatus">Payment Status</label>
                                            <input type="text" class="form-control" id="editStatus" name="edit_status" readonly>
                                        </div> -->
                                </div>
                                <div class="form-group">
                                    <label for="editNotes">Notes</label>
                                    <textarea class="form-control" id="editNotes" name="edit_notes" rows="2"
                                        placeholder="Additional notes..."></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="editTerms">Terms</label>
                                    <textarea class="form-control" id="editTerms" name="edit_terms" rows="2"
                                        placeholder="Payment terms..."></textarea>
                                </div>
                            </form>
                        </div>
                        <!-- Preview Bill Tab Content -->
                        <div class="tab-pane fade" id="edit-preview-bill-tab" role="tabpanel"
                            aria-labelledby="edit-preview-bill-tab-link">
                            <div id="editPreviewBillContent">
                                <p class="text-muted">Click the "Preview Bill" button in the Edit Bill tab to see the
                                    details here.</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-info" id="editPreviewBillButton">Preview Bill</button>
                    <button type="submit" form="editBillForm" class="btn btn-primary">Save Changes</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="createAssignBillModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createAssignBillModalLabel">Create / Assign Bill</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <!-- Nav tabs -->
                    <ul class="nav nav-pills mb-3" id="assignBillTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                            <a class="nav-link active" id="assign-bill-tab-link" data-toggle="pill"
                                href="#assign-bill-tab" role="tab" aria-controls="assign-bill-tab"
                                aria-selected="true">Assign Bill</a>
                        </li>
                        <li class="nav-item" role="presentation">
                            <a class="nav-link" id="preview-bill-tab-link" data-toggle="pill" href="#preview-bill-tab"
                                role="tab" aria-controls="preview-bill-tab" aria-selected="false">Preview Bill</a>
                        </li>
                    </ul>

                    <!-- Tab panes -->
                    <div class="tab-content" id="assignBillTabsContent">
                        <!-- Assign Bill Tab Content -->
                        <div class="tab-pane fade show active" id="assign-bill-tab" role="tabpanel"
                            aria-labelledby="assign-bill-tab-link">
                            <form id="assignBillForm">
                                <div class="row">
                                    <!-- Bill Type -->
                                    <div class="col-md-12 form-group">
                                        <label for="selectBillTypeModal">Select Bill Type</label>
                                        <select class="form-control select2" id="selectBillTypeModal"
                                            name="bill_type_id" style="width: 100%;" title="Select Bill Type" required>
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><input type="text" name="assign_breakdown_description[]"
                                                        class="form-control" placeholder="e.g. Uniform Fee" required>
                                                </td>
                                    ...
                                    <div class="table-responsive" style="max-height: 300px; overflow-y: auto;">
                                        <table class="table table-sm table-bordered" id="studentListTableModal">
                                            ...
                                            <tbody id="studentListTableBodyModal">
                                                <tr>
                                                    <td colspan="4" class="text-center text-muted">Select a class to
                                                        view students.</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    <small class="text-muted">You can select students from multiple classes. Selected
                                        students will be remembered.</small>
                                </div>
                                <!-- Preview Button -->
                                <div class="col-md-12 mt-3 text-right">
                                    <button type="button" class="btn btn-info" id="previewBillButton">Preview
                                        Bill</button>
                                </div>
                            </form>
                        </div>
                        <!-- Preview Bill Tab Content -->
                        <div class="tab-pane fade" id="preview-bill-tab" role="tabpanel"
                            aria-labelledby="preview-bill-tab-link">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    <button type="button" class="btn btn-primary" id="assignNowButton" disabled>Assign Now</button>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <form id="editBillTypeForm">
                        ...
                        <div class="row">
                            <div class="col-md-6 form-group">
                                <label for="editTaxPercentage">Tax (%)</label>
                                <input type="number" min="0" max="100" step="0.01" class="form-control"
                                    id="editTaxPercentage" name="taxPercentage" value="0">
                            </div>
                            <div class="col-md-6 form-group">
    ...
    <div class="modal fade" id="quickAssignBillModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Nav tabs -->
                    <ul class="nav nav-pills mb-3" id="quickAssignBillTabs" role="tablist">
                        <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content" id="quickAssignBillTabsContent">
                        ...
                        <div class="tab-pane fade show active" id="quick-assign-bill-tab" role="tabpanel"
                            ...
                            <form id="quickAssignBillForm">
                                ...
                                <div class="col-md-12 mt-3 text-right">
                                    <button type="button" class="btn btn-info" id="quickPreviewBillButton">Preview
                                        Bill</button>
                                </div>
                            </form>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancel</button>
                    <button type="submit" form="quickAssignBillForm" class="btn btn-primary">Assign Bill</button>
                </div>
            </div>
        </div>
    </div>
    <div class="modal fade" id="createBillTypeModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <p class="modal-title font-weight-bold" id="createBillTypeModalLabel">Create New Bill Type</p>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script src="../dist/js/account.js?v=110"></script>
    <!-- date-range-picker -->
