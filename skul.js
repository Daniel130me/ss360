...
function get_lesson_note_selected_classes() {
    ...
    return Array.isArray(selectedClasses) ? selectedClasses : [selectedClasses];

}



function get_lesson_note_active_term() {

    return $('.lesson_term.select_btn.active').attr('data-name') || $('.term.select_btn.active').attr('data-name') || '';

}



function reset_lesson_note_multi_class_select() {

    const currentClass = $("#select_class_field").val();

    const $target = $("#lesson_note_multi_class");

    if ($target.length && currentClass) {
...
function get_lesson_note_body() {
                        ...
                        <div class="py-3 px-15 bg-white" style="border-radius: 10px;">
                            ...
                            <div class="form-group mb-0 w-100" id="lesson_note_body_editor" style="display:none;">
                                ...
                                <div class="alert alert-info py-2 px-3 mb-3" style="font-size: 14px;">
                                    ...
                                    Upload images with the toolbar image button or the Upload Image button below. To copy this same note to other classes, tick the extra classes before saving. The current class is selected automatically.
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <label>Save this note for</label>

                                    <small class="form-text text-muted mb-2">Leave only the current class selected for a normal save, or choose more classes to copy this topic and content to them.</small>
    ...
    `);
        ...
        ClassicEditor.create(document.querySelector("#lesson_body"), {
            ...
            simpleUpload: {
                ...
                // Use the same endpoint as the fallback upload button so images behave consistently.
                    ...
                    if (viewEl) {
                        ...
                        `;
                            ...
                            fileInput.addEventListener("change", function (e) {
                                ...
                                form.append("total_size", usedNow + file.size);
    ...
    $.ajax({
        ...
        beforeSend: () => {
            ...
            reset_lesson_note_multi_class_select();
...
function create_lesson_note_body() {
    ...
    const selectedClasses = get_lesson_note_selected_classes();

    const activeTerm = get_lesson_note_active_term();
        ...
        success: (response) => {
            ...
            try {
                ...
                if (data.status !== "1") {
                    ...
                    toastr.error(data.err || "Lesson note could not be saved");

                    return;

                }

                toastr.success("Lesson note saved");
        ...
        success: (response) => {
            ...
            try {
                ...
                if (data.status !== "1") {
                    ...
                    toastr.error(data.err || "Lesson note topic could not be saved");

                    return;

                }

                toastr.success("Lesson note topic saved");
