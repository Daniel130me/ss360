                        ...
                        <div class="d-flex mb-3 align-items-center">
                            ...
                            <div>
                                <select class="select2 filter_Select border-0 form-control"
                                    id="select_class_field_report" onchange="get_stud_byClass_report()">
                                    <?php
                                ...
                                <tr>
                                    <th colspan="2" class="">
                                        <div style="display: flex; align-items: center;">
                                            ...
                                            <p class="font-weight-normal action_btn"
                                                style="display:none; margin: 0; cursor: pointer;"
                                                onclick="get_all_checked_checkbox_for_report('multiple',null,'report_card_modal','bulk_report_ids')">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select class="form-control select2" name="term" id="select_term_field" style="width: 100%;"
                            required>
                    ...
                    <div class="card-foot">
                        ...
                        <button type="button" id="student_transfer_btn" class="btn-sm btn-primary"
                            onclick="preview_report_card_multiple('report_page','term')">Preview Report</button>
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" id="download-pdf-button" class="btn btn-success"
                        onclick="downloadAllReports()" disabled>
