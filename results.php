            ...
            <div class="content fade-in p-0">
                <div class="hero-section d-flex flex-column align-items-center justify-content-center" style="position: relative;">
                    <div style="position: absolute; top: 20px; right: 30px;">
                        <a href="logout" title="Logout" style="color: #fff; display: inline-block; text-decoration: none;">
                            <span class="material-symbols-outlined" style="font-size: 2.2rem; vertical-align: middle; cursor: pointer;">logout</span>
                        </a>
                    </div>
                    ...
                    <div class="thecontentbox" style="display: none">
                        <div class="container-fluid" id="">
                            <div class="py-3 px-15 bg-white space_content_box" style="border-radius: 10px; position: relative">
                                <!-- <div id=""> -->
                                <div id="session_select" class="input-group mb-3 d-flex align-items-md-center align-items-start" style="width: 300px;">
