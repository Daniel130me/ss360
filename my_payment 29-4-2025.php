                                        ...
                                        <form id="paymentForm" class="payment-form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" id="term_id" name="term_id"
                                                    ...
                                                    <option selected value="3">Third Term</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="amount-info">Cost per student: ₦500 (7.5% VAT excluded)</div>
                                            </div>
                            ...
                            <div class="col-12 col-md-8">
                                <div class="py-3 px-15 bg-white" style="border-radius: 10px;">
                                    ...
                                    switch ($row['session_id']) {
                                        case 1: echo '2023/2024'; break;
                                        case 2: echo '2024/2025'; break;
                                        case 3: echo '2025/2026'; break;
                                    }
                                    ?></td>
                                                <td><?php
                                    switch ($row['term_id']) {
