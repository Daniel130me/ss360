...
<body class="hold-transition sidebar-mini">
                ...
                <div class="container-fluid">
                    ...
                    <div class="container-fluid mt-4 px-0">
                        <div class="py-3 px-15 bg-white" style="border-radius: 10px;">
                            ...
                            <div class="row">
                            <div class="form-group mb-0 col-12 col-sm-4">
                                <label for="" class="mb-0">Which CA is this score for?</label>
                                <div class="d-flex" style="max-width: 350px;">
                                    <?php if ($school_settings['ca1'] == 1): ?>
                                        <div class="input-group mb-3 d-flex align-items-center icheck-gray-dark mr-3" style="width: auto;">
                                    ...
                                    <?php if ($school_settings['practical'] == 1): ?>
                                        <div class="input-group mb-3 d-flex align-items-center icheck-gray-dark" style="width: auto;">
    ...
    <div class="modal fade" id="existingAssessmentModal" tabindex="-1" role="dialog" aria-labelledby="existingAssessmentModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="existingAssessmentModalLabel">Existing Assessment Found</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    An assessment already exists for this subject and type with the selected classes. Would you like to edit the existing assessment?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" onclick="handleExistingAssessmentResponse(false)">No</button>
    ...
    <script src="../dist/js/examination.js?v=king1an"></script>
    <script>
