                            ...
                            <div class="py-2 px-15 bg-white" style="border-radius: 10px;">
                                ...
                                <div id="student_payment_record_container" class="">
                                    ...
                                    <div id="estimated-income-section" class="mb-3"
                                        ...
                                        <div id="student-record-filters" class="mb-3 d-flex menu-scrollbar" style="overflow: auto; white-space: nowrap; width:100%; column-gap: 40px;">
...
<div class="modal fade" id="createAssignBillModal" tabindex="-1" role="dialog"
                ...
                <form id="recordPaymentForm">
                    <div class="modal-body">
                        ...
                        <div class="p-3 mb-2 bg-secondary">
                            ...
                            <p class="small" id="balance_calculate">Balance = <span id="amount_balance_record_payment"></span></p>
                        </div>
                        <div class="form-group">
                            <label for="payment_amount">Amount Paid</label>
                            <input type="number" class="form-control" id="payment_amount" name="amount_newly_paid"
                                min="0" step="0.01" oninput="recalculate_balance()" required>
                        </div>
                        <div class="form-group">
    ...
    <script src="../dist/js/accounts.js?v=11a"></script>
    <!-- date-range-picker -->
