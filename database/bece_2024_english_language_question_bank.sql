...
SELECT '<p><small>Source: BECE 2024 English Language - Item 1 - Question 1</small></p><p><strong>BECE 2024 English Language - Question 1</strong></p><p>Choose from the options A to D, the one which most suitably completes the sentence.</p><p>Ali&#039;s parents have not bought ....... of the two recommended books.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Sentence Completion', '', 'approved', 0, 0, 0, 0, NOW(), 0
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 2 - Question 2</small></p><p><strong>BECE 2024 English Language - Question 2</strong></p><p>Choose from the options A to D, the one which most suitably completes the sentence.</p><p>We were served a ....... meal at that cosy restaurant.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Sentence Completion', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 4 - Question 4</small></p><p><strong>BECE 2024 English Language - Question 4</strong></p><p>Choose from the options A to D, the one which most suitably completes the sentence.</p><p>Adwoa&#039;s daughter is allergic ....... dust.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Sentence Completion', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 5 - Question 5</small></p><p><strong>BECE 2024 English Language - Question 5</strong></p><p>Choose from the options A to D, the one which most suitably completes the sentence.</p><p>Konlaan suggested that it was time they ....... for the meeting.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Sentence Completion', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 6 - Question 6</small></p><p><strong>BECE 2024 English Language - Question 6</strong></p><p>Choose from the options A to D, the one which most suitably completes the sentence.</p><p>At my last interview, I faced ....... panel.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Sentence Completion', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 7 - Question 7</small></p><p><strong>BECE 2024 English Language - Question 7</strong></p><p>Choose from the options A to D, the one which most suitably completes the sentence.</p><p>Last month, there was .......</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Sentence Completion', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 9 - Question 9</small></p><p><strong>BECE 2024 English Language - Question 9</strong></p><p>Choose from the options A to D, the one which most suitably completes the sentence.</p><p>If Azameti had won gold, Ghanaians .......</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Sentence Completion', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 12 - Question 12</small></p><p><strong>BECE 2024 English Language - Question 12</strong></p><p>Choose from the options A to D, the one which most suitably completes the sentence.</p><p>You haven&#039;t met each other before, ....... you?</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Sentence Completion', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 16 - Question 16</small></p><p><strong>BECE 2024 English Language - Question 16</strong></p><p>Choose from the options A to D, the one which is nearest in meaning to the underlined word in each sentence.</p><p>Mama said, &quot;You can only fight off bullies if you are <u>assertive</u>&quot;.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Synonyms', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 17 - Question 17</small></p><p><strong>BECE 2024 English Language - Question 17</strong></p><p>Choose from the options A to D, the one which is nearest in meaning to the underlined word in each sentence.</p><p>The <u>salient</u> points of the topic have been thoroughly discussed.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Synonyms', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 20 - Question 20</small></p><p><strong>BECE 2024 English Language - Question 20</strong></p><p>Choose from the options A to D, the one which is nearest in meaning to the underlined word in each sentence.</p><p>We&#039;re so excited because Amuzu&#039;s <u>proposal</u> has been accepted.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Synonyms', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 21 - Question 21</small></p><p><strong>BECE 2024 English Language - Question 21</strong></p><p>In each of the following sentences a group of words has been underlined. Choose from the options A to D, the one that best explains the underlined group of words.</p><p>&quot;Do not be such a <u>wet blanket</u>, Afua. Your brother needs all the support you can give him&quot;, Auntie Araba chided her daughter.</p><p>This means that Afua ...... her brother.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Idioms / Meaning in Context', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 23 - Question 23</small></p><p><strong>BECE 2024 English Language - Question 23</strong></p><p>In each of the following sentences a group of words has been underlined. Choose from the options A to D, the one that best explains the underlined group of words.</p><p>Asuo had to <u>eat his words</u> when Asante Kotoko lost to Tano Bofoakwa FC.</p><p>This means that Asuo .......</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Idioms / Meaning in Context', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 24 - Question 24</small></p><p><strong>BECE 2024 English Language - Question 24</strong></p><p>In each of the following sentences a group of words has been underlined. Choose from the options A to D, the one that best explains the underlined group of words.</p><p>The fraudster was <u>paid back in his own coins</u>.</p><p>This means that he was .......</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Idioms / Meaning in Context', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 26 - Question 26</small></p><p><strong>BECE 2024 English Language - Question 26</strong></p><p>Choose from the options A to D, the one that is most nearly opposite in meaning to the underlined word in each sentence.</p><p>Regions with <u>abundant</u> rainfall are different from those having ....... moisture.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Antonyms', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 27 - Question 27</small></p><p><strong>BECE 2024 English Language - Question 27</strong></p><p>Choose from the options A to D, the one that is most nearly opposite in meaning to the underlined word in each sentence.</p><p>Due to the ongoing road construction, our shops have been <u>temporarily</u> closed down.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Antonyms', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 28 - Question 28</small></p><p><strong>BECE 2024 English Language - Question 28</strong></p><p>Choose from the options A to D, the one that is most nearly opposite in meaning to the underlined word in each sentence.</p><p>It is hard to tell when this began or where it will .......</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Antonyms', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 29 - Question 29</small></p><p><strong>BECE 2024 English Language - Question 29</strong></p><p>Choose from the options A to D, the one that is most nearly opposite in meaning to the underlined word in each sentence.</p><p>Some exercises may seem easy in <u>theoretical</u> terms but can be really difficult in ....... aspects.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Antonyms', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 30 - Question 30</small></p><p><strong>BECE 2024 English Language - Question 30</strong></p><p>Choose from the options A to D, the one that is most nearly opposite in meaning to the underlined word in each sentence.</p><p>It is good to get a cure for a disease, but it is better to ....... the disease.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Antonyms', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 33 - Question 33</small></p><p><strong>BECE 2024 English Language - Question 33</strong></p><p>In the following passage, the numbered gaps indicate missing words. Against each number in the list below the passage are four options arranged in columns lettered A to D. For each numbered gap, choose from the options provided, the word that is most suitable.</p><p><strong>Passage</strong></p><p>The meeting began with the reading of the minutes of the previous meeting. The Chairman asked if there were any corrections to be made to the minutes. Then one member complained that after checking the <strong>-31-</strong> list, he realised that his name had been wrongly spelt. The Chairman apologised for the error and the matter was resolved. Two <strong>-32-</strong> were proposed and voted on. At the end of the discussions, the Chairman asked a member to <strong>-33-</strong> for the closure of the meeting. Tetteh Oko did and he was <strong>-34-</strong> by Adjoa Mansa. The meeting was then <strong>-35-</strong> to a new date.</p><p>Select the word that best fills gap <strong>-33-</strong>.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Cloze Passage', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 35 - Question 35</small></p><p><strong>BECE 2024 English Language - Question 35</strong></p><p>In the following passage, the numbered gaps indicate missing words. Against each number in the list below the passage are four options arranged in columns lettered A to D. For each numbered gap, choose from the options provided, the word that is most suitable.</p><p><strong>Passage</strong></p><p>The meeting began with the reading of the minutes of the previous meeting. The Chairman asked if there were any corrections to be made to the minutes. Then one member complained that after checking the <strong>-31-</strong> list, he realised that his name had been wrongly spelt. The Chairman apologised for the error and the matter was resolved. Two <strong>-32-</strong> were proposed and voted on. At the end of the discussions, the Chairman asked a member to <strong>-33-</strong> for the closure of the meeting. Tetteh Oko did and he was <strong>-34-</strong> by Adjoa Mansa. The meeting was then <strong>-35-</strong> to a new date.</p><p>Select the word that best fills gap <strong>-35-</strong>.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Cloze Passage', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2024 English Language - Item 38 - Question 38</small></p><p><strong>BECE 2024 English Language - Question 38</strong></p><p>Choose from the options A to D, the one which has the same consonant sound as the word underlined in the sentences below.</p><p>Lariba sp<u>r</u>ang to her feet.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Consonant Sound', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
