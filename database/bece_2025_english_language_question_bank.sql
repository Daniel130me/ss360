...
SELECT '<p><small>Source: BECE 2025 English Language - Item 1 - Question 1</small></p><p><strong>BECE 2025 English Language - Question 1</strong></p><p>Choose from the options A to D, the one which most suitably completes the sentence.</p><p><strong>If it rained, the farmer ........ his seeds.</strong></p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Sentence Completion', '', 'approved', 0, 0, 0, 0, NOW(), 0
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 2 - Question 2</small></p><p><strong>BECE 2025 English Language - Question 2</strong></p><p>Choose from the options A to D, the one which most suitably completes the sentence.</p><p><strong>The laptop is ...... than the other two.</strong></p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Sentence Completion', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 3 - Question 3</small></p><p><strong>BECE 2025 English Language - Question 3</strong></p><p>Choose from the options A to D, the one which most suitably completes the sentence.</p><p><strong>Although there were ten beautiful bags in the shop, Sandra liked ........ of them.</strong></p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Sentence Completion', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 5 - Question 5</small></p><p><strong>BECE 2025 English Language - Question 5</strong></p><p>Choose from the options A to D, the one which most suitably completes the sentence.</p><p><strong>Our dog ........ barking since the stranger entered the house.</strong></p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Sentence Completion', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 7 - Question 7</small></p><p><strong>BECE 2025 English Language - Question 7</strong></p><p>Choose from the options A to D, the one which most suitably completes the sentence.</p><p><strong>We saw ........ people in the room.</strong></p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Sentence Completion', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 8 - Question 8</small></p><p><strong>BECE 2025 English Language - Question 8</strong></p><p>Choose from the options A to D, the one which most suitably completes the sentence.</p><p><strong>Put the books on the shelf, ........?</strong></p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Sentence Completion', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 9 - Question 9</small></p><p><strong>BECE 2025 English Language - Question 9</strong></p><p>Choose from the options A to D, the one which most suitably completes the sentence.</p><p><strong>Amira prepared a delicious meal for her ........</strong></p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Sentence Completion', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 10 - Question 10</small></p><p><strong>BECE 2025 English Language - Question 10</strong></p><p>Choose from the options A to D, the one which most suitably completes the sentence.</p><p><strong>The coach advised the two players to cooperate with ........</strong></p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Sentence Completion', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 13 - Question 13</small></p><p><strong>BECE 2025 English Language - Question 13</strong></p><p>Choose from the options A to D, the one which most suitably completes the sentence.</p><p><strong>To ........ did you deliver the message?</strong></p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Sentence Completion', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 16 - Question 16</small></p><p><strong>BECE 2025 English Language - Question 16</strong></p><p>Choose from the options A to D, the one which is nearest in meaning to the underlined word in the sentence.</p><p>Paul <u>purposely</u> left the door open.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Synonyms', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 17 - Question 17</small></p><p><strong>BECE 2025 English Language - Question 17</strong></p><p>Choose from the options A to D, the one which is nearest in meaning to the underlined word in the sentence.</p><p>Nobody paid any attention to the workers&#039; <u>demands</u>.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Synonyms', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 20 - Question 20</small></p><p><strong>BECE 2025 English Language - Question 20</strong></p><p>Choose from the options A to D, the one which is nearest in meaning to the underlined word in the sentence.</p><p>His <u>dubious</u> attitude has made him lose all his good friends.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Synonyms', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 22 - Question 22</small></p><p><strong>BECE 2025 English Language - Question 22</strong></p><p>In each of the following sentences, a group of words has been underlined. Choose from the options A to D, the one that best explains the underlined group of words.</p><p>She tried to <u>throw dust in our eyes</u>. This means that she tried to ........</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Idioms / Meaning in Context', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 23 - Question 23</small></p><p><strong>BECE 2025 English Language - Question 23</strong></p><p>In each of the following sentences, a group of words has been underlined. Choose from the options A to D, the one that best explains the underlined group of words.</p><p>On seeing the angry mob approaching the school, our school prefect told us to <u>take to our heels</u>. This means that the prefect told us to ........</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Idioms / Meaning in Context', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 25 - Question 25</small></p><p><strong>BECE 2025 English Language - Question 25</strong></p><p>In each of the following sentences, a group of words has been underlined. Choose from the options A to D, the one that best explains the underlined group of words.</p><p>I learnt to <u>paddle my own canoe</u>. This means that I ........</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Idioms / Meaning in Context', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 26 - Question 26</small></p><p><strong>BECE 2025 English Language - Question 26</strong></p><p>Choose from the options A to D, the one that is most nearly opposite in meaning to the underlined word to fill the gap in the sentence.</p><p>The Policeman was reported to have <u>concealed</u> the evidence, but ........ it to the Jury.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Antonyms', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 27 - Question 27</small></p><p><strong>BECE 2025 English Language - Question 27</strong></p><p>Choose from the options A to D, the one that is most nearly opposite in meaning to the underlined word to fill the gap in the sentence.</p><p>He loves taking <u>hasty</u> decisions so he never makes ........ moves.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Antonyms', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 28 - Question 28</small></p><p><strong>BECE 2025 English Language - Question 28</strong></p><p>Choose from the options A to D, the one that is most nearly opposite in meaning to the underlined word to fill the gap in the sentence.</p><p>Those children think their uncle is <u>miserly</u> yet he is ........ to strangers.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Antonyms', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 29 - Question 29</small></p><p><strong>BECE 2025 English Language - Question 29</strong></p><p>Choose from the options A to D, the one that is most nearly opposite in meaning to the underlined word to fill the gap in the sentence.</p><p>Though we expected <strong>.......</strong>, the judge handled the case with <u>partiality</u></p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Antonyms', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 30 - Question 30</small></p><p><strong>BECE 2025 English Language - Question 30</strong></p><p>Choose from the options A to D, the one that is most nearly opposite in meaning to the underlined word to fill the gap in the sentence.</p><p>The minister publicly <u>rebukes</u> his assistant and always ........ his secretary.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Antonyms', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 33 - Question 33</small></p><p><strong>BECE 2025 English Language - Question 33</strong></p><p>In the following passage, the numbered gaps indicate missing words. Against each number in the list below the passage are four options arranged in columns lettered A to D. For each numbered gap, choose from the options provided, the word that is most suitable.</p><p><strong>Passage</strong></p><p>Akuba was trained as an accountant. After graduation, she went out to <strong>-31-</strong> employment. She visited several firms but was <strong>-32-</strong> in securing a job. Afiba, her friend, finally advised her to read the newspapers for <strong>-33-</strong> of vacant positions. Fortunately, a reputable company was looking for a <strong>-34-</strong> accountant who was <strong>-35-</strong> in financial reporting. Akuba immediately submitted her application, attended an interview and within a week, she received an appointment letter. Her patience and perseverance had finally paid off.</p><p>Afiba, her friend, finally advised her to read the newspapers for <strong>-33-</strong> of vacant positions.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Cloze Passage', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 34 - Question 34</small></p><p><strong>BECE 2025 English Language - Question 34</strong></p><p>In the following passage, the numbered gaps indicate missing words. Against each number in the list below the passage are four options arranged in columns lettered A to D. For each numbered gap, choose from the options provided, the word that is most suitable.</p><p><strong>Passage</strong></p><p>Akuba was trained as an accountant. After graduation, she went out to <strong>-31-</strong> employment. She visited several firms but was <strong>-32-</strong> in securing a job. Afiba, her friend, finally advised her to read the newspapers for <strong>-33-</strong> of vacant positions. Fortunately, a reputable company was looking for a <strong>-34-</strong> accountant who was <strong>-35-</strong> in financial reporting. Akuba immediately submitted her application, attended an interview and within a week, she received an appointment letter. Her patience and perseverance had finally paid off.</p><p>Fortunately, a reputable company was looking for a <strong>-34-</strong> accountant who was <strong>-35-</strong> in financial reporting.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Cloze Passage', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 35 - Question 35</small></p><p><strong>BECE 2025 English Language - Question 35</strong></p><p>In the following passage, the numbered gaps indicate missing words. Against each number in the list below the passage are four options arranged in columns lettered A to D. For each numbered gap, choose from the options provided, the word that is most suitable.</p><p><strong>Passage</strong></p><p>Akuba was trained as an accountant. After graduation, she went out to <strong>-31-</strong> employment. She visited several firms but was <strong>-32-</strong> in securing a job. Afiba, her friend, finally advised her to read the newspapers for <strong>-33-</strong> of vacant positions. Fortunately, a reputable company was looking for a <strong>-34-</strong> accountant who was <strong>-35-</strong> in financial reporting. Akuba immediately submitted her application, attended an interview and within a week, she received an appointment letter. Her patience and perseverance had finally paid off.</p><p>Fortunately, a reputable company was looking for a professional accountant who was <strong>-35-</strong> in financial reporting.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Cloze Passage', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 37 - Question 37</small></p><p><strong>BECE 2025 English Language - Question 37</strong></p><p>Choose from the options A to D, the one which has the same initial consonant sound as the word underlined in the sentence below.</p><p>We won the <u>game</u> easily.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Initial Consonant Sound', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
...
SET @existing_question_id := (SELECT id FROM question_bank WHERE source_type = 'exam_body' AND exam_body_id = @bece_exam_body_id AND subject_id = @english_subject_id AND question LIKE CONCAT('%', @source_marker, '%') ORDER BY id ASC LIMIT 1);
INSERT INTO question_bank (question, subject_id, class_id, source_type, exam_body_id, topic_id, difficulty, recommended_class, term_tag, question_category, explanation, review_status, quality_score, times_used, school_id, createdby, datecreated, deleted)
SELECT '<p><small>Source: BECE 2025 English Language - Item 38 - Question 38</small></p><p><strong>BECE 2025 English Language - Question 38</strong></p><p>Choose from the options A to D, the one which has the same initial consonant sound as the word underlined in the sentence below.</p><p>She received a beautiful <u>psalm</u>.</p>', @english_subject_id, 0, 'exam_body', @bece_exam_body_id, 0, 'Medium', 'JSS3', '', 'Initial Consonant Sound', '', 'approved', 0, 0, 0, 0, NOW(), 0
WHERE @existing_question_id IS NULL;
SET @question_id := COALESCE(@existing_question_id, LAST_INSERT_ID());
INSERT INTO question_bank_options (question_id, options, answer, deleted)
