...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action == 'settings') {
        ...
        if (does_it_exist('session_id', 'skul_settings', "session_id='$session' AND school_id='{$_SESSION['school_id']}'")) {
            // echo "here";
            $query = "UPDATE skul_settings SET first='$first',
            second='$second',
            third='$third',ca1='$ca1',ca2='$ca2',ca3='$ca3',
            practical='$practical',exam='$exam',grading='$grading',dateupdated='$date', 
            ...
            if ($update) {
                ...
                echo $update === true ? json_encode(array('status' => '1', "msg" => "Updated Succesfully")) : mysqli_error($conn);
            }
        } else {
            // echo "here2";
            $insert  = mysqli_query($conn, "INSERT INTO 
            skul_settings (session_id,first,second,third,ca1,ca2
            ,ca3,practical,exam,grading,datecreated,createdby,school_id)
            VALUES('$session','$first','$second','$third',
            '$ca1','$ca2','$ca3','$practical','$exam',$grading,
            ...
            if ($insert) {
                ...
                echo $insert === true ? json_encode(array('status' => '1', "msg" => "Updated Succesfully")) : mysqli_error($conn);
            }
        }
        mysqli_query($conn, "UPDATE school SET session_id='$session', term_id='$term_id' WHERE id='{$_SESSION['school_id']}'");
    ...
    if ($action == 'school_info_update') {
        ...
        if ($_FILES['logo']['name'] == '') {
            $updateschool = mysqli_query(
                $conn,
                "UPDATE school SET school_name='$schoolname',
            address='$address',city='$city',
            state='$state',country='$country',
            phone1='$phone1',phone2='$phone2',
            email='$email',twitter='$twitter',
            instagram='$instagram',facebook='$facebook',
            tiktok='$tiktok',description='$description',
            ...
            if (in_array($ext, $valid_ext)) {
                ...
                if (move_uploaded_file($tmp, $path)) {
                    $updateschool = mysqli_query($conn, "UPDATE school SET logo='$final_img', school_name='$schoolname',address='$address',city='$city',state='$state',country='$country',phone1='$phone1',phone2='$phone2',email='$email',twitter='$twitter',instagram='$instagram',facebook='$facebook',tiktok='$tiktok',description='$description',dateupdated='$date', updatedby='{$_SESSION['userid']}' WHERE id='$school_id'");
                    $_SESSION['logo'] = $final_img;
                }
            }
        }
        if ($_FILES['back_gpic']['name'] == '') {
            $updateschool = mysqli_query(
                $conn,
                "UPDATE school SET school_name='$schoolname',
            address='$address',city='$city',
            ...
            if (in_array($ext, $valid_ext)) {
                $path = $path . $final_img_bg;
                if (move_uploaded_file($tmp, $path)) {
                    $updateschool = mysqli_query($conn, "UPDATE school SET back_pic='$final_img_bg', school_name='$schoolname',address='$address',city='$city',state='$state',country='$country',phone1='$phone1',phone2='$phone2',email='$email',twitter='$twitter',instagram='$instagram',facebook='$facebook',tiktok='$tiktok',description='$description',dateupdated='$date', updatedby='{$_SESSION['userid']}' WHERE id='$school_id'");
        ...
        if ($updateschool) {
            echo $updateschool === true ? json_encode(array('status' => '1', 'msg' => "Updated successfully")) : mysqli_error($conn);
        }
    }
    ...
    if ($action === 'login') {
        ...
        if (mysqli_num_rows($result) < 1) {
            $result = mysqli_query($conn, "SELECT id,email,school_id,passw,firstname, lastname FROM parent WHERE phone = '$phone'");
...
?>
        ...
        <form action="" onsubmit="update_sub_cat_form(event)" class="update_sub_cat_form">
            ...
            <div>
                <div class="form-group">
                    ...
                    <input id="subject_category_name" value="<?= $row['category_name'] ?>" name="category_name" type="text" placeholder="Category name" class="form-control" required>
            ...
            <div class="row flex-wrap mt-2 ml-0">
                ...
                ?>
                        <div class="icheck-gray-dark col-12 col-sm-3 mr-4 mb-3 mb-sm-0">
                            <input type="checkbox" class="subject_checkbox" value="<?= $subrow['id'] ?>" name="<?= $subrow['subject'] ?>" id="<?= $random . $subrow['id'] ?>" checked>
            ...
            <div class="card-foot">
                ...
                <button type="submit" id="update_subj_cat_btn" class="btn btn-primary">Save update</button>
    ...
    if ($action == 'get_att') {
        ...
        // $student_ids = explode(",", $_POST['student_id']);
        // $idsbox = [];
        // // echo count($student_ids);
        // if (count($student_ids) > 1) {
        //     for ($i = 0; $i < count($student_ids); $i++) {
        //         array_push($idsbox, "a.student_id=" . "'$student_ids[$i]'");
        //     }
        //     $student_line = "(" . implode(" OR ", $idsbox) . ")";
        // } else {
        //     $student_line = "a.student_id=" . "'$student_ids[0]'";
        // }
        // echo $student_line;
        // exit;
        if ($start_date == "term") {
            $sql = "SELECT s.lastname,s.firstname,s.middlename,a.student_id,a.state,a.att_date 
            FROM attendance a, students s WHERE a.class_id='$class_id'
            AND a.class_id='$class_id'
            AND a.student_id=s.id AND a.att_date 
            AND a.term='{$_SESSION['term_id']}'";
        }
        if ($start_date == "session") {
            ...
            AND a.class_id='$class_id'
            AND a.student_id=s.id AND a.att_date 
            AND a.session_id='{$_SESSION['session_id']}'";
        } else {
            $sql = "SELECT s.lastname,s.firstname,s.middlename,a.student_id,a.state,a.att_date 
        FROM attendance a, students s WHERE a.class_id='$class_id'
        AND a.class_id='$class_id'
    ...
    ?>
            ...
            ?>
                <tr class="comment_tb_row">
                    ...
                    <td>
                        ...
                        ?>
                        <textarea name="" rows="2" cols="" class="w-100 teacher_comment_comment" style="padding: 5px; border-radius:5px;" placeholder="Teacher's comment"><?= $comment_teacher ?></textarea>
                    </td>
                    <td>
                    ...
                    ?>
                        <td>
                            <textarea name="" rows="2" cols="" class="w-100 principal_comment_comment" style="padding: 5px; border-radius:5px;" placeholder="Principal/Propietors' comment"><?= $comment_principal ?></textarea>
                        </td>
                    <?php } ?>
                </tr>
            <?php
                ...
                <tr>
                    ...
                    <td>
                        <div>
                            ...
                            <a onclick="get_all_checked_checkbox_for_report('single','<?= $row['id'] ?>','report_card_modal','bulk_report_ids')" class="btn btn-sm p-0 accent mr-3">Download Report Card</a>
        ...
        if ($action === 'get_stud_byClass_attendance') {
            ...
            $select = mysqli_query($conn, "SELECT c.id as class_id,s.id as id,s.lastname,s.firstname,s.middlename 
            FROM students s, class c WHERE s.class_id=c.id 
            AND s.class_id='$class_id' AND s.school_id='$school_id' 
            ...
            $select_att = mysqli_query($conn, "SELECT student_id,state,att_date FROM attendance
                WHERE class_id='$class_id' AND session_id='$session_id' 
                AND term_id='$term_id' AND att_date='$att_date' AND school_id='$school_id'");

            $data = [];
            while ($att_row = mysqli_fetch_array($select_att)) {
                $data[$att_row['student_id']] = $att_row['state'];
            }
            $student_arry = array_keys($data, '1');
            while ($row = mysqli_fetch_array($select)) {
            ...
            ?>
                <tr>
                    <td style="width: 10px;">
                        <div class="icheck-primary">
                            <input type="checkbox" <?= in_array($row['id'], $student_arry) ? 'checked' : '' ?> class="table_checkbox take_att_checkbox" onchange="check_checkbox()" id="check<?= $row['id'] ?>" value="<?= $row['id'] ?>">
                            <label for="check<?= $row['id'] ?>"></label>
                        </div>
                    </td>
                    <td class="">
        ...
        if ($action == 'set_attendance') {
            ...
            foreach ($register as $student_id => $state) {
                // echo $reg.'and'.$student_id;
                if (does_it_exist('id', 'attendance', "att_date='$att_date' AND student_id='$student_id' AND term_id='$term_id' AND class_id='$class_id' AND session_id='$session_id' AND school_id='$school_id'")) {
                    $update = mysqli_query($conn, "UPDATE attendance SET state='$state',
                    dateupdated='$date', updatedby='{$_SESSION['userid']}' 
                    WHERE att_date='$att_date' AND student_id='$student_id' 
                    AND term_id='$term_id' AND class_id='$class_id' 
                    AND session_id='$session_id' 
                    AND school_id='$school_id'");
                } else {
                    $insert  = mysqli_query($conn, "INSERT INTO attendance 
                    (state,student_id,session_id,term_id,class_id,
                    school_id,att_date,createdby,datecreated)
                    VALUES('$state','$student_id','$session_id',
                    '$term_id','$class_id','$school_id','$att_date','{$_SESSION['userid']}','$date')");
                }
                            ...
                            <div class="col-12">
                                ...
                                <div class="row flex-wrap" style="border-bottom:5px solid #f4f7fa">
                                    <div class="mb-3 col-sm-4 col-12">
                                        ...
                                        <input id="firstname" name="firstname" type="text" placeholder="Firstname" value="<?= $row['firstname'] ?>" class="form-control">
                                    </div>
                                    <div class="mb-3 col-sm-4 col-12">
                                        <p for="lastname" class="font-weight-bold mb-0 small muted-text">Lastname</p>
                                        <input name="lastname" type="text" placeholder="Lastname" value="<?= $row['lastname'] ?>" class="form-control">
                                    </div>
                                    <div class="mb-3 col-sm-4 col-12">
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <div class="row flex-wrap">
                                    ...
                                    <div class="mb-3 col-sm-4 col-12">
                                        ...
                                        <input type="text" name="address" value="<?= $row['address'] ?>" autocomplete="address" class="form-control" placeholder="e.g. 10, Kings Street, Victoria Island, Lagos." id="">
                                    </div>
                                    <div class="mb-3 col-sm-4 col-12">
                                        <p class="font-weight-bold small muted-text">City</p>
                                        <input type="text" name="city" autocomplete="address-level1" value="<?= $row['city'] ?>" class="form-control" placeholder="e.g. Victoria Island" id="">
                                    </div>
                                    <div class="mb-3 col-sm-4 col-12">
                                        <p class="font-weight-bold small muted-text">State</p>
                                        <input type="text" name="state" value="<?= $row['state'] ?>" autocomplete="address-level1" class="form-control" placeholder="e.g. Lagos" id="">
                                    </div>
                                    <div class="mb-3 col-sm-4 col-12">
                                        <p class="font-weight-bold small muted-text">Country</p>
                                        <input type="text" name="country" value="<?= $row['country'] ?>" autocomplete="address-level1" class="form-control" placeholder="e.g. Nigeria" id="">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            ?>
                <form onsubmit="update_parent_data(event)">
                    <div class="container-fluid">
                        ...
                        <div class="card-foot">
                            <button type="submit" id="update_parent_submit_btn" class="btn btn-primary">Update</button>
                            <button type="button" class="btn btn-grey" class="close" data-dismiss="modal" aria-label="Close">Cancel</button>
                        </div>
                    </div>
                </form>
        ...
        if ($action === 'get_student_data_for_update') {
            $school_id = $_SESSION['school_id'];
            $id = test_input($_POST['id']);
            $select  = mysqli_query($conn, "SELECT c.classname,p.id,p.firstname as pfirstname,
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <div class="w-100 mb-3">
                                    ...
                                    <input type="text" value="<= $row['parentphone'] ?>" name="parentphone" oninput="input_search(this)" class="form-control search_parentphone" autocomplete="tel" placeholder="Parent phone number" required>
        ...
        if ($action == 'add_class_data') {
            ...
            if (!does_it_exist("id", "class", "classname='$classname'")) {
                $insertclass = mysqli_query($conn, "INSERT INTO class(subject_cat,classname,school_id,createdby,datecreated) 
            VALUES('$subject_cat','$classname','$school_id','{$_SESSION['userid']}','$date')");
                echo $insertclass === true ? json_encode(array('status' => '1', 'msg' => 'Created Successfully')) : mysqli_error($conn);
            } else {
                echo json_encode(array('status' => '0', "err" => "Class already exist"));
            }
        }
        if ($action == 'add_staff_data') {
            ...
            // $class_id = test_input($_POST['class_id']);
            if (!does_it_exist("phone", "staff", "phone='$phone' AND email='$email'")) {
        ...
        if ($action == 'get_priviledges') {
            ...
            $select = mysqli_query($conn, "SELECT id,update_school,register_staff,register_student,edit_student,change_class,add_class 
    ...
    <?php
        ...
        if ($action == 'update_student_data') {
            ...
            // // exit;
            // $hashedpassword = password_hash($password, PASSWORD_ARGON2I);
            if (!does_it_exist("phone", "parent", "phone='$parentphone'")) { // if parent does not exist
                // if parent record doesn not exist, check the email sent, if it exists, return it
                if (does_it_exist("email", "parent", "email='$parentemail'")) {
                    echo json_encode(array('status' => '0', 'err' => "The email has been used by another parent, try another."));
                    exit;
                }
                // if the parent in formation does not exist, we add new parent and update the srudent ifnormation
                $pfname = test_input($_POST['parentfname']);
                $plname = test_input($_POST['parentlname']);
                $address = test_input($_POST['address']);
                $city = test_input($_POST['city']);
                ...
                if ($_FILES['studentphoto']['name'] == '') {
                    $final_img = "avatar.png";
                    $insertparent = mysqli_query($conn, "INSERT INTO parent(firstname,lastname,phone, email, address,city,state,country, school_id)
                    VALUES('$pfname','$plname','$parentphone','$parentemail','$address','$city', '$state','$country','$school_id')");
                    if ($insertparent) {
                        // echo 'here1';
                        $selectparentid = mysqli_query($conn, "SELECT id FROM parent WHERE phone='$parentphone' AND email='$parentemail' AND school_id='$school_id'");
                        if ($row = mysqli_fetch_array($selectparentid)) {
                            // echo 'here2';
                            $parent_id = $row['id'];
                            $updatestudent = mysqli_query(
                                $conn,
                                "UPDATE students SET status='$status', firstname='$firstname',lastname='$lastname',
                        middlename='$middlename',class_id='$class_id',
                        gender='$gender',dob='$dob',phone='$phone',email='$email',
                        parent_id='$parent_id',dateupdated='$date', 
                        updatedby='{$_SESSION['userid']}' WHERE school_id='$school_id' AND id='$id'"
                            );
                            ...
                            if ($insertparent) {
                                ...
                                if ($row = mysqli_fetch_array($selectparentid)) {
                                    ...
                                    if (in_array($ext, $valid_ext)) {
                                        $path = $path . $final_img;
                                        if (move_uploaded_file($tmp, $path)) {
                                            $updatestudent = mysqli_query($conn, "UPDATE students SET status='$status', photo='$final_img', firstname='$firstname',lastname='$lastname',middlename='$middlename',class_id='$class_id',gender='$gender',dob='$dob',phone='$phone',email='$email',parent_id='$parent_id',dateupdated='$date', updatedby='{$_SESSION['userid']}' WHERE school_id='$school_id' AND id='$id'");
                                        }
                                    }
                                }
                                echo $updatestudent === true ? json_encode(array('status' => '1')) : mysqli_error($conn);
                ...
                // if parent recod already exist, select the id of the parent and edit the student information
                $select_parent_id = mysqli_query($conn, "SELECT id FROM parent WHERE phone='$parentphone'");
                $parent_id_row = mysqli_fetch_array($select_parent_id);
                $parent_id = $parent_id_row['id'];
                if ($_FILES['studentphoto']['name'] == '') {
                ...
                $updatestudent = mysqli_query(
                    $conn,
                    "UPDATE students SET status='$status', photo='$final_img', 
            ...
            WHERE school_id='$school_id' AND id='$id'"
                ...
                // check for leftover/unattached parent
            ...
            // $valid_ext = array("jpg", "png", "jpeg");
            // if ($_FILES['studentphoto']['name'] == '') {
            //     $updatestudent = mysqli_query($conn, "UPDATE students SET firstname='$firstname',lastname='$lastname',middlename='$middlename',class_id='$class_id',gender='$gender',dob='$dob',phone='$phone',email='$email',parent_id='$parent_id',dateupdated='$date', updatedby='{$_SESSION['userid']}' WHERE school_id='$school_id' AND id='$id'");
            // } else {
            //     $img_name = $_FILES['studentphoto']['name'];
            //     $tmp = $_FILES['studentphoto']['tmp_name'];
            //     // delete the previous file
            ...
            //         $path = $path . $final_img;
            //         if (move_uploaded_file($tmp, $path)) {
            //             $updatestudent = mysqli_query($conn, "UPDATE students SET photo='$final_img', firstname='$firstname',lastname='$lastname',middlename='$middlename',class_id='$class_id',gender='$gender',dob='$dob',phone='$phone',email='$email',parent_id='$parent_id',dateupdated='$date', updatedby='{$_SESSION['userid']}' WHERE school_id='$school_id' AND id='$id'");
            //         }
            //     }
            //     // }
            // }
            // if ($updatestudent) {
            //     $updateparent = mysqli_query($conn, "UPDATE parent SET passw='$hashedpassword', phone='$parentphone', email='$parentemail', address='$address', city='$city', state='$state', country='$country' WHERE school_id='$school_id' AND id='$parent_id' ");
            // }
            // echo $updateparent === true ? json_encode(array('status' => '1')) : mysqli_error($conn);
        }
