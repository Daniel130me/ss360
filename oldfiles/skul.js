...
function format_student_table_report(student_score_data, term, session_id, class_id, grading) {
    ...
    $.ajax({
        ...
        success: (data) => {
            ...
            if (student_score_data.length <= 1) {
                $(".data_overlay").html(`
                    <p class="font-weight-bold">No record for the student selected</p>
                `)
                return
            }
            $(".thecontentbox").show()
...
function fetchSelectedDates_att(startDate, endDate) {
    $.ajax({
        ...
        success: function (response) {
            ...
            dates.forEach(date => {
                tableHeader += `<th class="font-weight-normal">${moment(date).format('DD-MM')}</th>`;
            });
            
            tableHeader += `
                        <th class="font-weight-normal">Present</th>
                        <th class="font-weight-normal">Absent</th>
                    </tr>
                </thead>`;
            ...
            students.forEach(student_id => {
                ...
                tableBody += `<td>${presentCount}</td><td>${absentCount}</td></tr>`;
            });
            ...
            if ($("#by_all").hasClass('active')) {
                tableHtml = `
                    ...
                    <tr class="${filtertype === 'student' ? 'd-none' : ''}">
                        ...
                        ${settingsData.ca1 == 1 ? `<td><input type="number" class="w-xs-60 assess_input ca1total" ${approval_data.ca1 == '0' ? 'disabled' : ''} onchange="updatehiddentotals(this,'ca1total')" value="${scores.length > 0 ? scores[0].ca1Total || '' : ''}" /></td>` : ''}
                        ${settingsData.ca1 == 1 ? `<td class="d-non ${hideshowtotals}"><input type="number" class="w-xs-60 assess_input ca1total" ${approval_data.ca1 == '0' ? 'disabled' : ''} onchange="updatehiddentotals(this,'ca1total')" value="${scores.length > 0 ? scores[0].ca1Total || '' : ''}" /></td>` : ''}
                        ${settingsData.ca2 == 1 ? `<td><input type="number" class="w-xs-60 assess_input ca2total" onchange="updatehiddentotals(this,'ca2total')" ${approval_data.ca2 == '0' ? 'disabled' : ''} value="${scores.length > 0 ? scores[0].ca2Total || '' : ''}" /></td>` : ''}
                        ${settingsData.ca2 == 1 ? `<td class="d-non ${hideshowtotals}"><input type="number" class="w-xs-60 assess_input ca2total" ${approval_data.ca2 == '0' ? 'disabled' : ''} onchange="updatehiddentotals(this,'ca2total')" value="${scores.length > 0 ? scores[0].ca2Total || '' : ''}" /></td>` : ''}
                        ${settingsData.ca3 == 1 ? `<td><input type="number" class="w-xs-60 assess_input ca3total" onchange="updatehiddentotals(this,'ca3total')" ${approval_data.ca3 == '0' ? 'disabled' : ''} value="${scores.length > 0 ? scores[0].ca3Total || '' : ''}" /></td>` : ''}
                        ${settingsData.ca3 == 1 ? `<td class="d-non ${hideshowtotals}"><input type="number" class="w-xs-60 assess_input ca3total" onchange="updatehiddentotals(this,'ca3total')" ${approval_data.ca3 == '0' ? 'disabled' : ''} value="${scores.length > 0 ? scores[0].ca3Total || '' : ''}" /></td>` : ''}
                        ${settingsData.pra == 1 ? `<td><input type="number" class="w-xs-60 assess_input pratotal" onchange="updatehiddentotals(this,'pratotal')" ${approval_data.practical == '0' ? 'disabled' : ''} value="${scores.length > 0 ? scores[0].praTotal || '' : ''}" /></td>` : ''}
                        ${settingsData.pra == 1 ? `<td class="d-non ${hideshowtotals}"><input type="number" class="w-xs-60 assess_input pratotal" onchange="updatehiddentotals(this,'pratotal')" ${approval_data.practical == '0' ? 'disabled' : ''} value="${scores.length > 0 ? scores[0].praTotal || '' : ''}" /></td>` : ''}
                        ${settingsData.exa == 1 ? `<td><input type="number"  class="w-xs-60 assess_input exatotal" onchange="updatehiddentotals(this,'exatotal')" ${approval_data.exam == '0' ? 'disabled' : ''} value="${scores.length > 0 ? scores[0].examTotal || '' : ''}" /></td>` : ''}
                        ${settingsData.exa == 1 ? `<td class="d-non ${hideshowtotals}"><input type="number"  class="w-xs-60 assess_input exatotal" onchange="updatehiddentotals(this,'exatotal')" ${approval_data.exam == '0' ? 'disabled' : ''} value="${scores.length > 0 ? scores[0].examTotal || '' : ''}" /></td>` : ''}
                    </tr>
                    ${arrayValues.map((arrayValue) => {
                    let nameToMatch = filtertype === 'student' ? arrayValue.subject : arrayValue.name;
                    ...
                    return `<tr>
                            ...
                            ${settingsData.ca1 == 1 ? `<td><input class="w-xs-60 assess_input ca1Total" type="number" ${approval_data.ca1 == '0' ? 'disabled' : ''} value="${score.ca1 || ''}"></td>` : ''}
                            ${settingsData.ca1 == 1 ? `<td class="d-non ${hideshowtotals}"><input class="w-xs-60 assess_input ca1total" type="number" ${approval_data.ca1 == '0' ? 'disabled' : ''} value="${score.ca1Total || ''}"></td>` : ''}
                            ${settingsData.ca2 == 1 ? `<td><input class="w-xs-60 assess_input" type="number" ${approval_data.ca2 == '0' ? 'disabled' : ''} value="${score.ca2 || ''}"></td>` : ''}
                            ${settingsData.ca2 == 1 ? `<td class="d-non ${hideshowtotals}"><input class="w-xs-60 assess_input ca2total" type="number" ${approval_data.ca2 == '0' ? 'disabled' : ''} value="${score.ca2Total || ''}"></td>` : ''}
                            ${settingsData.ca3 == 1 ? `<td><input class="w-xs-60 assess_input" type="number" ${approval_data.ca2 == '0' ? 'disabled' : ''} value="${score.ca3 || ''}"></td>` : ''}
                            ${settingsData.ca3 == 1 ? `<td class="d-non ${hideshowtotals}"><input class="w-xs-60 assess_input ca3total" ${approval_data.ca3 == '0' ? 'disabled' : ''} type="number" value="${score.ca3Total || ''}"></td>` : ''}
                            ${settingsData.pra == 1 ? `<td><input class="w-xs-60 assess_input" type="number" ${approval_data.ca3 == '0' ? 'disabled' : ''} value="${score.pra || ''}"></td>` : ''}
                            ${settingsData.pra == 1 ? `<td class="d-non ${hideshowtotals}"><input class="w-xs-60 assess_input pratotal" ${approval_data.practical == '0' ? 'disabled' : ''} type="number" value="${score.praTotal || ''}"></td>` : ''}
                            ${settingsData.exa == 1 ? `<td><input class="w-xs-60 assess_input" type="number" ${approval_data.exam == '0' ? 'disabled' : ''} value="${score.exam || ''}"></td>` : ''}
                            ${settingsData.exa == 1 ? `<td class="d-non ${hideshowtotals}"><input class="w-xs-60 assess_input exatotal" ${approval_data.exam == '0' ? 'disabled' : ''} type="number" value="${score.examTotal || ''}"></td>` : ''}
                        </tr>`;
                }).join('')}
                    </tbody>`;
            } else if ($("#by_ca1").hasClass('active')) {
                tableHtml = `
                    ...
                    <tr class="${filtertype === 'student' ? 'd-none' : ''}">
                        <td class="font-xs-16 assess_subject" data-id="NAN">Total</td>
                        <td><input type="number" class="w-xs-60 assess_input" ${approval_data.ca1 == '0' ? 'disabled' : ''} onchange="updatehiddentotals(this,'ca1total')" value="${scores.length > 0 ? scores[0].ca1Total || '' : ''}" /></td>
                        <td class="d-non ${hideshowtotals}"><input type="number" ${approval_data.ca1 == '0' ? 'disabled' : ''} class="assess_input ca1total" value="${scores.length > 0 ? scores[0].ca1Total || '' : ''}" /></td>
                    </tr>
                    ${arrayValues.map((arrayValue) => {
                    let nameToMatch = filtertype === 'student' ? arrayValue.subject : arrayValue.name;
                    let score = scores.find(s => s.subjectsOrNames.trim() === nameToMatch.trim()) || {};
                    ...
                    return `<tr>
                            <td class="font-xs-16 assess_subject" data-id=${arrayValue.id}>${nameToMatch}</td>
                            ${viewOrPostPage === 'post' ? `<td><input class="w-xs-60 assess_input" type="number" ${approval_data.ca1 == '0' ? 'disabled' : ''} value="${score.ca1 || ''}"></td>` : `<td>${score.ca1 || ''}</td>`}
                            ${viewOrPostPage === 'post' ? `<td class="d-non ${hideshowtotals}"><input class="w-xs-60 assess_input ca1total" ${approval_data.ca1 == '0' ? 'disabled' : ''} type="number" value="${score.ca1Total || ''}"></td>` : `<td>${score.ca1Total || ''}</td>`}
                        </tr>`;
                }).join('')}
                    </tbody>`;
            }
                ...
                tableHtml = `
                    ...
                    <tr class="${filtertype === 'student' ? 'd-none' : ''}">
                        <td class="font-xs-16 assess_subject" data-id="NAN">Total</td>
                        <td><input type="number" class="w-xs-60 assess_input" ${approval_data.ca2 == '0' ? 'disabled' : ''} onchange="updatehiddentotals(this,'ca2total')" value="${scores.length > 0 ? scores[0].ca2Total || '' : ''}" /></td>
                        <td class="d-non ${hideshowtotals}"><input type="number" ${approval_data.ca2 == '0' ? 'disabled' : ''} class="assess_input ca2total" value="${scores.length > 0 ? scores[0].ca2Total || '' : ''}" /></td>
                    </tr>
                    ${arrayValues.map((arrayValue) => {
                    let nameToMatch = filtertype === 'student' ? arrayValue.subject : arrayValue.name;
                    let score = scores.find(s => s.subjectsOrNames.trim() === nameToMatch.trim()) || {};
                    ...
                    return `<tr>
                            <td class="font-xs-16 assess_subject" data-id=${arrayValue.id}>${nameToMatch}</td>
                            ${viewOrPostPage === 'post' ? `<td><input class="w-xs-60 assess_input" type="number" ${approval_data.ca2 == '0' ? 'disabled' : ''} value="${score.ca2 || ''}"></td>` : `<td>${score.ca2 || ''}</td>`}
                            ${viewOrPostPage === 'post' ? `<td class="d-non ${hideshowtotals}"><input class="w-xs-60 assess_input ca2total" ${approval_data.ca2 == '0' ? 'disabled' : ''} type="number" value="${score.ca2Total || ''}"></td>` : `<td>${score.ca2Total || ''}</td>`}
                        </tr>`;
                }).join('')}
                    </tbody>`;
            }
                ...
                tableHtml = `
                    ...
                    <tr class="${filtertype === 'student' ? 'd-none' : ''}">
                        <td class="font-xs-16 assess_subject" data-id="NAN">Total</td>
                        <td><input type="number" class="w-xs-60 assess_input" ${approval_data.ca3 == '0' ? 'disabled' : ''} onchange="updatehiddentotals(this,'ca3total')" value="${scores.length > 0 ? scores[0].ca3Total || '' : ''}" /></td>
                        <td class="d-non ${hideshowtotals}"><input type="number" ${approval_data.ca3 == '0' ? 'disabled' : ''} class="assess_input ca3total" value="${scores.length > 0 ? scores[0].ca3Total || '' : ''}" /></td>
                    </tr>
                    ${arrayValues.map((arrayValue) => {
                    let nameToMatch = filtertype === 'student' ? arrayValue.subject : arrayValue.name;
                    let score = scores.find(s => s.subjectsOrNames.trim() === nameToMatch.trim()) || {};
                    ...
                    return `<tr>
                            <td class="font-xs-16 assess_subject" data-id=${arrayValue.id}>${nameToMatch}</td>
                            ${viewOrPostPage === 'post' ? `<td><input class="w-xs-60 assess_input" ${approval_data.ca3 == '0' ? 'disabled' : ''} type="number" value="${score.ca3 || ''}"></td>` : `<td>${score.ca3 || ''}</td>`}
                            ${viewOrPostPage === 'post' ? `<td class="d-non ${hideshowtotals}"><input class="w-xs-60 assess_input ca3total" ${approval_data.ca3 == '0' ? 'disabled' : ''} type="number" value="${score.ca3Total || ''}"></td>` : `<td>${score.ca3Total || ''}</td>`}
                        </tr>`;
                }).join('')}
                    </tbody>`;
            }
                ...
                tableHtml = `
                    ...
                    <tr class="${filtertype === 'student' ? 'd-none' : ''}">
                        <td class="font-xs-16 assess_subject" data-id="NAN">Total</td>
                        <td><input type="number" class="w-xs-60 assess_input" ${approval_data.practical == '0' ? 'disabled' : ''} onchange="updatehiddentotals(this,'pratotal')" value="${scores.length > 0 ? scores[0].praTotal || '' : ''}" /></td>
                        <td class="d-non ${hideshowtotals}"><input type="number" ${approval_data.practical == '0' ? 'disabled' : ''} class="assess_input pratotal" value="${scores.length > 0 ? scores[0].praTotal || '' : ''}" /></td>
                    </tr>
                    ${arrayValues.map((arrayValue) => {
                    let nameToMatch = filtertype === 'student' ? arrayValue.subject : arrayValue.name;
                    let score = scores.find(s => s.subjectsOrNames.trim() === nameToMatch.trim()) || {};
                    ...
                    return `<tr>
                            <td class="font-xs-16 assess_subject" data-id=${arrayValue.id}>${nameToMatch}</td>
                            ${viewOrPostPage === 'post' ? `<td><input class="w-xs-60 assess_input" ${approval_data.pratical == '0' ? 'disabled' : ''} type="number" value="${score.pra || ''}"></td>` : `<td>${score.pra || ''}</td>`}
                            ${viewOrPostPage === 'post' ? `<td class="d-non ${hideshowtotals}"><input class="w-xs-60 assess_input pratotal" ${approval_data.practical == '0' ? 'disabled' : ''} type="number" value="${score.praTotal || ''}"></td>` : `<td>${score.ca3Total || ''}</td>`}
                        </tr>`;
                }).join('')}
                    </tbody>`;
            }
                ...
                tableHtml = `
                    ...
                    <tr class="${filtertype === 'student' ? 'd-none' : ''}">
                        <td class="font-xs-16 assess_subject" data-id="NAN">Total</td>
                        <td><input type="number" class="w-xs-60 assess_input" ${approval_data.exam == '0' ? 'disabled' : ''} onchange="updatehiddentotals(this,'exatotal')" value="${scores.length > 0 ? scores[0].examTotal || '' : ''}" /></td>
                        <td class="d-non ${hideshowtotals}"><input type="number" class="assess_input exatotal" ${approval_data.exam == '0' ? 'disabled' : ''} value="${scores.length > 0 ? scores[0].examTotal || '' : ''}" /></td>
                    </tr>
                    ${arrayValues.map((arrayValue) => {
                    let nameToMatch = filtertype === 'student' ? arrayValue.subject : arrayValue.name;
                    let score = scores.find(s => s.subjectsOrNames.trim() === nameToMatch.trim()) || {};
                    ...
                    return `<tr>
                            <td class="font-xs-16 assess_subject" data-id=${arrayValue.id}>${nameToMatch}</td>
                            ${viewOrPostPage === 'post' ? `<td><input class="w-xs-60 assess_input" type="number" ${approval_data.exam == '0' ? 'disabled' : ''} value="${score.exam || ''}"></td>` : `<td>${score.exa || ''}</td>`}
                            ${viewOrPostPage === 'post' ? `<td class="d-non ${hideshowtotals}"><input class="w-xs-60 assess_input exatotal" ${approval_data.exam == '0' ? 'disabled' : ''} type="number" value="${score.examTotal || ''}"></td>` : `<td>${score.exaTotal || ''}</td>`}
                        </tr>`;
                }).join('')}
                    </tbody>`;
            }
...
function update_parent_data(event) {
    ...
    $.ajax({
        ...
        success: (data) => {
            data = JSON.parse(data)
            $("#update_parent_submit_btn").html('Update')
            $("#update_parent_submit_btn").attr('disabled', true)
            if (data.status == '1') {
                // $("#staff_tables").load('display_staff_table.php')
