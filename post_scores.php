        ...
        <div class="content-wrapper" style="padding-bottom: 100px;">
            ...
            <div class="content">
                                ...
                                <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-12 my-md-0">
                                            <p class="text-orange">Current Term: <span class="term_name font-weight-bold"><?= $_SESSION['term_id'] == 1 ? '1st' : ($_SESSION['term_id'] == 2 ? '2nd' : '3rd') ?></span></p>
                                            <div class="form-group">
                                                <label for="" class="mb-0">Select method for posting scores</label>
                                                <div class="w-100">
                                                    <button class="btn select_btn active mr-2" id="by_subj_btn" onclick="handleSelect('by_subj_btn')">Post By Subject</button>
                                                    <button class="btn select_btn  mr-2" id="by_stud_btn" onclick="handleSelect('by_stud_btn')">Post By Student</button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-3" id="select_class">
                                            <div class="form-group align-left">
                                                ...
                                                <select class="form-control select2" onchange="setfilter('student')" id="select_class_field" style="width: 100%;">
                                                    <!-- <php
                                        ...
                                        <div class="col-12 col-md-3" id="select_student" style="display: none;">
                                            <div class="form-group align-left">
                                                ...
                                                <select class="form-control select2" onchange="setfilter('student')" id="select_student_field" style="width: 100%;">
                                                </select>
                                        ...
                                        <div class="col-12 col-md-3" id="select_subject">
                                            <div class="form-group align-left">
                                                ...
                                                <select class="form-control select2" onchange="setfilter('subject')" id="select_subject_field" style="width: 100%;">
                                                </select>
                                                <span class="small text-danger" id="select_subject_warning" style="display: none;">Selected class has no subjects</span>
                                            </div>
                                        </div>
                                        <input type="hidden" id="select_session_field" value="<?=$_SESSION['session_id']?>">
                                        <input type="hidden" class="select_btn term active" data-name="<?=$_SESSION['term_id']?>">
                ...
                <div class="container-fluid mt-4">
                    <div class="py-3 px-15 bg-white data_overlay" style="border-radius: 10px; position: relative"><p class="font-weight-bold">Fill the form appropiately</p></div>
                </div>
                    ...
                    <div class="container-fluid mt-4">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 col-md-auto mb-2 mb-md-0">
                                <button class="btn btn-primary btn-block btn-md-auto" onclick="submitScores()">Submit Scores</button>
                            </div>
                        </div>
                        ...
                        <div>
                            <form class="form">
                                <div class="form-group">
                                    ...
                                    <input name="comment" style="border-radius: 0; border-top:0; border-left:0; border-right:0;" class="form-control" id="post_teacher_comment_message" placeholder="Write comment">
                            ...
                            <div>
                                <form class="form">
                                    <div class="form-group">
                                        ...
                                        <input name="comment" style="border-radius: 0; border-top:0; border-left:0; border-right:0;" class="form-control" id="post_principal_comment_message" placeholder="Write comment">
                                        <input type="hidden" name="action" value="submit_comment">
                                        <input type="hidden" name="term" class="comment_term" value="">
