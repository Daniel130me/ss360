                ...
                if (viewEl) {
                    ...
                    if (!uploadGroup) {
                        ...
                        fileInput.addEventListener('change', function (e) {
                            ...
                            fetch('../controller.php?action=upload_lesson_image', {
                                method: 'POST',
                                body: form
                            })
                                .then(res => res.json())
                                .then(resp => {
                                    if (resp && resp.url) {
                                        const insertImageByUrl = (url) => {
                                            try {
                                                // If editor supports image insertion via the model, use it
                                                if (editorInstance && editorInstance.model && editorInstance.model.schema && editorInstance.model.schema.checkChild) {
                                                    ...
                                                    // Some builds support the 'imageInsert' command
                                                    try {
                                                    ...
                                                    // Final fallback: append raw HTML
